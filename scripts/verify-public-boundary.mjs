...
const allowedTopLevel = new Set(['.github', '.gitignore', '.nojekyll', '404.html', 'README.md', 'index.html', 'locales.js', 'og.png', 'package.json', 'robots.txt', 'script.js', 'scripts', 'styles.css']);
